        ...
        <div className="z-30 fixed inset-0 flex items-center justify-center bg-slate-900/20 backdrop-blur-sm p-4 animate-fadeIn">
            <div className="bg-white/96 backdrop-blur-xl rounded-[1.5rem] border border-slate-200 p-6 w-full max-w-md shadow-[0_24px_80px_rgba(15,23,42,0.12)] animate-scaleIn">
                <div className="flex justify-between items-center mb-6">
                    ...
                    <button 
                        onClick={shareLink} 
                        className="p-2 text-slate-500 hover:text-slate-900 hover:bg-slate-100 rounded-xl transition-all duration-300"
                    >
                ...
                <div className="space-y-4">
                    ...
                    {sharableLink ? (
                        <button
                            onClick={copyLink}
                            className="w-full bg-gradient-to-r from-orange-500 to-amber-400 hover:from-orange-400 hover:to-amber-300 text-white py-3.5 rounded-full font-medium transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed text-sm shadow-[0_12px_24px_rgba(249,115,22,0.18)] hover:shadow-[0_14px_28px_rgba(249,115,22,0.24)]"
                            disabled={loading}
                        >
                        ...
                        <button
                            ...
                            className="w-full bg-slate-900 hover:bg-slate-800 text-white py-3.5 rounded-full font-medium transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed text-sm border border-slate-900/10 shadow-[0_12px_24px_rgba(15,23,42,0.12)]"
                            disabled={loading}
                        >
                            <div className="flex items-center justify-center space-x-2">
                                {loading ? (
