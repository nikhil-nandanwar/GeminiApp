...
function Navbar({ sidebarOpen, setSidebarOpen }) {
    ...
    return (
        <>
            <nav className="w-full z-20 fixed border-b border-slate-200 bg-white/90 backdrop-blur-xl">
                    ...
                    <div className="flex items-center justify-between h-16">
                        ...
                        <div className="flex items-center space-x-2">
                            <button
                                ...
                                className="flex items-center space-x-2 text-slate-600 hover:text-slate-900 px-4 py-2 rounded-full text-sm border border-slate-200 bg-white hover:border-orange-200 hover:bg-orange-50 transition-all duration-300 group"
                            >
